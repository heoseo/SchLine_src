...
public class ScheduleAppBoardVO {
	...
	public ScheduleAppBoardVO() {}


	public ScheduleAppBoardVO(String month, String year, int iDX, int sUB_IDX, String tITLE, String cONTENT, Date pOSTDATE,
			int rNUM, int cHECK_FLAG, String noti_or_exam, int board_idx, int subject_idx, String board_type,
			String user_id, String board_title, String board_content, String board_file, Date board_postdate,
			String board_flag_te, int exam_idx, String user_name, String subject_name, String exam_name,
			Date exam_postdate, Date exam_date, String exam_type, String exam_content, String exam_scoring,
