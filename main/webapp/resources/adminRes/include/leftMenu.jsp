        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li>
                        <a href="/schline/admin/userList" class="waves-effect"><i class="fa fa-user fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">사용자</span></a>
                    </li>
                    <li>
                        <a href="/schline/admin/class" class="waves-effect"><i class="fa fa-table fa-fw"
