...
function taskWrite(subject_idx, exam_idx){
	$.ajax({
		url : "examStart.do",
		type : "post",
		data : {"subject_idx" : subject_idx, "exam_idx" : exam_idx},
		dataType : "html",
	...
	<p style="text-align:center; font-size:1.2em">${subject_name } 과제</p>
		<div class="table-wrapper">
			...
			<c:forEach items="${examlist }" var="trow" varStatus="tloop">
				...
				<tr>
					<td style="width:20%; overflow:hidden;">${trow.exam_name }</td>
					<td style="text-align:left;">${trow.exam_content }</td>	
