...
<body class="is-preload">	
	...
	<section>
		<pre>
			<code>
				<h2 style="font-weight: bold;">화학 3주차 과제</h2><button type="button" class="button primary">제출하기</button>
			</code>
		</pre>
			...
			<div class="row gtr-uniform">
				...
				<div class="col-3 col-12-small">
					<select name="demo-category" id="demo-category">
						...
						<option value="1">B반</option>
						<option value="1">C반</option>
						<option value="1">D반</option>
						<option value="1">E반</option>
					</select>
				</div>
