...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="resources/adminRes/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- Menu CSS -->
    <link href="resources/adminRes/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css" rel="stylesheet">
    <!-- toast CSS -->
    <link href="resources/adminRes/plugins/bower_components/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- morris CSS -->
    <link href="resources/adminRes/plugins/bower_components/morrisjs/morris.css" rel="stylesheet">
    <!-- animation CSS -->
    <link href="resources/adminRes/css/animate.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="resources/adminRes/css/style.css" rel="stylesheet">
    <!-- color CSS -->
    <link href="resources/adminRes/css/colors/blue-dark.css" id="theme" rel="stylesheet">
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center">
                                <div class="comment-body">
                                    <div class="user-img"> <img src="resources/adminRes/plugins/images/users/pawandeep.jpg" alt="user"
                                ...
                                <div class="comment-body">
                                    <div class="user-img"> <img src="resources/adminRes/plugins/images/users/sonu.jpg" alt="user"
                                            class="img-circle"> </div>
                                    <div class="mail-contnet">
                                ...
                                <div class="comment-body b-none">
                                    <div class="user-img"> <img src="resources/adminRes/plugins/images/users/arijit.jpg" alt="user"
                                            class="img-circle"> </div>
                                    <div class="mail-contnet">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                ...
                                <a href="#">
                                    <div class="user-img"> <img src="resources/adminRes/plugins/images/users/genu.jpg" alt="user"
                                            class="img-circle"> <span class="profile-status online pull-right"></span>
                                    </div>
                                    <div class="mail-contnet">
