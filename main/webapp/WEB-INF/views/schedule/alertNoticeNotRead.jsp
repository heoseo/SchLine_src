...
$(function() {
	$('#taskButton').click(function() {
		...
		$('#taskMain').load('alertTaskForm.jsp'),f;
	});
});
	...
	<div id="wrapper">
		...
		<br />
			<a href="#"><!-- ★★이미지클릭시 home으로 가기. home요청명 적기 -->
				<img src="<%=request.getContextPath() %>/resources/images/logo3.png" id="logo"  alt="스쿨라인 로고" width="200px;" />
			</a>
		<br />
		</div>
	<!--
	...
	<section>
		<pre>
			<code>
				...
				<button type="button" class="button primary" id="taskButton">제출하기</button>
			</code>
		</pre>
